...
import es.uned.lsi.eped.pract2022_2023.Node;
import es.uned.lsi.eped.pract2022_2023.NodeInfo;
import es.uned.lsi.eped.pract2022_2023.NodeInner;

public class GTree<E> extends Tree<E> implements GTreeIF<E> {

    private final ListIF<GTreeIF<E>> children;
